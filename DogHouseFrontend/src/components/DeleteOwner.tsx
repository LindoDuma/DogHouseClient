...
export default function DeleteOwner(props: any){
    ...
    return(
        <>
            <button className="bg-red-600 rounded-md w-auto h-auto hover:bg-red-800 transition-all duration-200 text-white text-center py-1 px-3" onClick={handleShow}><i className="bi bi-trash pr-1"></i>Delete</button>
            {show ? (
                ...
                <div className="bg-white w-2/6 h-auto rounded-md z-50">
                    <div className="flex h-14 align-middle items-center justify-between modal-header border-b border-gray-300">
                        <h1 className="px-4">Delete Owner</h1>
                    ...
                    <div className="flex h-14 px-4 align-middle items-center justify-between border-t border-gray-300">
                        <button onClick={() => props.deleteOwner(props.id)} className="bg-red-600 rounded-md w-auto h-auto hover:bg-red-800 transition-all duration-200 text-white text-center py-1 px-3">Delete</button>
